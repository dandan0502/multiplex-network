...
def parse_args():
    ...
    parser.add_argument('--directed', dest='directed', action='store_true',help='Treat graph as directed.')
    ...
    parser.add_argument('--weighted', dest='weighted', action='store_true', help='Treat graph as weighted')
